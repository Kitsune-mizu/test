  ...
  const fetchCooldown = async () => {
    try {
      const res = await fetch(
        `/api/auth/otp/cooldown?email=${encodeURIComponent(email)}`,
      );
  ...
  return (
    <div className="min-h-screen flex bg-neutral-50">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <span
          className="absolute -right-20 top-1/4 text-[400px] font-heading font-bold text-neutral-100 leading-none select-none"
          aria-hidden="true"
        >
          認
        </span>
        <span
          className="absolute -left-20 bottom-1/4 text-[300px] font-heading font-bold text-neutral-100 leading-none select-none"
          aria-hidden="true"
        >
          証
        </span>
          ...
          <div className="bg-white border border-neutral-200 shadow-xl relative">
              ...
              {isVerified ? (
                ...
                <>
                  ...
                  <div className="text-center mb-8">
                    ...
                    <p className="text-neutral-400 text-sm font-heading">
                      メール認証
                    </p>
                  </div>
                  ...
                  <p className="text-neutral-600 text-sm text-center mb-8">
                    Enter the 6-digit verification code sent to your email. The
                    code expires in{" "}
                    <span className="font-medium text-black">5 minutes</span>.
                  </p>
                  ...
                  <div className="flex justify-center mb-6">
                    ...
                    >
                      <InputOTPGroup>
                        <InputOTPSlot
                          index={0}
                          className="w-12 h-14 text-xl font-mono border-neutral-300 bg-neutral-50"
                        />
                        <InputOTPSlot
                          index={1}
                          className="w-12 h-14 text-xl font-mono border-neutral-300 bg-neutral-50"
            ...
            <div className="border-t border-neutral-200 px-8 py-4 bg-neutral-50">
              <p className="text-xs text-neutral-400 text-center">
                HIKARU BOUKEN &middot; Secure Email Verification &middot;{" "}
