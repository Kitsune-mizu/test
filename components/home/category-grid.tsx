...
const categories = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=400&h=500&fit=crop",
  },
];
...
export function CategoryGrid() {
  return (
    <section className="py-20 md:py-28 bg-neutral-50">
      ...
      <div
        className="absolute right-0 text-[180px] font-heading font-bold text-neutral-100 leading-none pointer-events-none select-none opacity-50"
        aria-hidden="true"
      >
        道
      </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-end justify-between mb-12">
          <div>
            ...
            <p className="mt-2 text-neutral-500">カテゴリー別にショップ</p>
          </div>
        </div>
