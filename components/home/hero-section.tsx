        ...
        <div className="mx-auto max-w-4xl">
          ...
          <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-black leading-[1.1] text-balance">
            ...
            <span className="relative">
              Modern Explorer
              <svg
                className="absolute -bottom-2 left-0 w-full h-3 text-[#E10600]"
                viewBox="0 0 200 12"
          ...
          <p className="mt-8 text-lg md:text-xl text-neutral-600 leading-relaxed max-w-2xl">
            Premium outdoor equipment crafted for those who seek adventure. From
            mountain trails to urban paths, we outfit your journey.
          </p>
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-start gap-4">
            <Button
              asChild
              size="lg"
              className="bg-black text-white hover:bg-neutral-800 gap-2 px-8 h-12"
            >
              <Link href="/products">
                Shop Collection
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-black text-black hover:bg-black hover:text-white h-12 px-8"
            >
          ...
          <div className="mt-20 pt-10 border-t border-neutral-200">
            <div className="grid grid-cols-3 gap-8 md:gap-16">
              <div>
                <p className="text-3xl md:text-4xl font-heading font-bold text-black">
                  50+
                </p>
                <p className="mt-1 text-sm text-neutral-500">Premium Brands</p>
                <p className="text-xs text-neutral-400 font-heading mt-0.5">
                  ブランド
                </p>
              </div>
              <div>
