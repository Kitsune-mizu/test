    ...
    <section className="py-20 md:py-28 bg-white border-t border-neutral-100">
      <div className="container mx-auto px-4">
          ...
          {features.map((feature, index) => (
            <div key={feature.title} className="relative">
              ...
              <div className="relative">
                ...
                {/* Content */}
                <h3 className="font-heading font-bold text-black mb-1">{feature.title}</h3>
                <p className="text-xs text-neutral-400 mb-2 font-heading">{feature.japanese}</p>
        ...
        <div className="mt-20 relative overflow-hidden bg-black text-white p-8 md:p-12">
          ...
          <span className="absolute right-4 top-1/2 -translate-y-1/2 text-[120px] font-heading font-bold text-white/5 leading-none pointer-events-none select-none" aria-hidden="true">
            旅
          </span>
          
          <div className="relative flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <p className="text-xs tracking-[0.3em] text-neutral-400 uppercase mb-2">Join the Adventure</p>
              <h3 className="font-heading text-2xl md:text-3xl font-bold">Ready to Explore?</h3>
              <p className="text-neutral-400 mt-2">Subscribe to get exclusive offers and adventure tips.</p>
            </div>
