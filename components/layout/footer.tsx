  ...
  return (
    <footer className="bg-black text-white">
      ...
      <div className="relative overflow-hidden">
        <div
          className="absolute top-0 right-0 text-[120px] font-heading font-bold text-white/[0.02] leading-none pointer-events-none select-none"
          aria-hidden="true"
        >
          旅
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-6 lg:col-span-1">
            ...
            <p className="text-sm text-neutral-400 leading-relaxed max-w-xs">
              Premium outdoor equipment for the modern explorer. Quality gear
              for hiking, camping, and adventure.
            </p>
          ...
          <div className="space-y-6">
            ...
            <nav className="flex flex-col gap-3">
              ...
              >
                Sandals{" "}
                <span className="text-neutral-600 text-xs ml-1">サンダル</span>
              </Link>
              <Link
              ...
              >
                Hiking Shoes{" "}
                <span className="text-neutral-600 text-xs ml-1">登山靴</span>
              </Link>
              <Link
        ...
        <div className="mt-16 pt-8 border-t border-neutral-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-neutral-500">
              &copy; {new Date().getFullYear()} Hikaru Bouken. All rights
              reserved.
            </p>
