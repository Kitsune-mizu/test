  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="absolute top-0 right-0 opacity-5 pointer-events-none">
        <span className="text-8xl font-heading font-bold text-red-600">読</span>
      </div>
    </div>
  );
}
    ...
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-5 pointer-events-none">
        <div className="relative">
          <span
            className="absolute text-9xl font-heading font-bold text-red-600 animate-pulse"
      ...
      <div className="absolute bottom-20 text-center space-y-2">
        ...
        <p className="text-xs text-muted-foreground">お待ちください</p>
      </div>
    </div>
  );
}
